...
const selectedText = document.getElementById("selected-companies");

// Deschide/inchide dropdown la click pe buton
dropdownBtn.addEventListener("click", function (event) {
    event.stopPropagation(); // Evită închiderea instantanee
...
// Actualizează selecțiile și afișează firmele selectate
dropdownMenu.addEventListener("change", function () {
    const selected = Array.from(dropdownMenu.querySelectorAll("input:checked"))
